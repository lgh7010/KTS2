...
public class KtsSystemTest {
    ...
    @Autowired
    TestListComponentService testListComponentService;
    @Autowired
    TestEditComponentService testEditComponentService;
    @Autowired
    TestcaseListComponentService testcaseListComponentService;
    @Autowired
    TestcaseEditComponentService testcaseEditComponentService;
