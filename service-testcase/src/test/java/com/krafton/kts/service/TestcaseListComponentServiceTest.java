...
@SpringBootTest(classes = TestcaseListComponentService.class)
public class TestcaseListComponentServiceTest {

    @Autowired
    private TestcaseListComponentService testcaseListComponentService;
